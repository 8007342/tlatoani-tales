...
This comic was made that way. The artefact teaches by existing — the repo you're reading is the evidence for every claim the comic made.
...
The skeptic's objection — "that only applies to code, not my real work" — dissolves when the answer is *"look at this comic; it applied to itself."* The proof isn't an argument; it's an artefact. You are holding the demonstration in your hand.
